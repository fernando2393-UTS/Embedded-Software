...
typedef struct
{
  ...
  OS_ECB *NotEmptySemaphore;	/*!< Semaphore which indicates whether the FIFO is empty or not */
  OS_ECB *NotFullSemaphore;	/*!< Semaphore which indicates whether the FIFO is full or not */
} TFIFO;
